<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WardenLogin.aspx.cs" Inherits="WebApplication2.WardenRegistration1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div  class="container">
            ...
            <table style=" padding-top:10%; width:100%; background-color:#f4a688; font-size:large; margin-right:30%">  
               
            <tr>  
                <td colspan="6" style=" padding-top:10%; text-align: center; vertical-align: top">  
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="True" Text="Warden Log In "></asp:Label>  
                </td>  
            </tr>
            ...
            <tr></tr>  
             ...
             <tr>  
                <td><a href="#" onclick="window.open('ForgetPasswordWarden.aspx','FP','width=500,height=100,top=300,left=500,fullscreen=no')">Forget Password</a></td>
