<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Nightout.aspx.cs" Inherits="WebApplication2.Nightout" %>
    ...
    <div class="container">
            ...
            <tr>  
             ...
             <tr>  
                ...
                <td style="text-align: center; padding-top:10%">  
                    <asp:TextBox ID="TextBox5" runat="server" Font-Size="X-Large"  AutoCompleteType="Disabled" ></asp:TextBox>
