<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentRegistration.aspx.cs" Inherits="WebApplication2.WardenRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form action="" style="background-color:#d64161; margin:100px; text-decoration:underline; color:Black; text-align:center; font-size:35px">  
        <div  class="container">
            ...
            <table style="width:100%; background-color:#b5e7a0; font-size:large; margin-right:30%">  
                
            <caption class="style1"> Student Registration Form  </caption> 
...
ForeColor="Red"></asp:RequiredFieldValidator>  
               ...
               <tr>  
                ...
                <tr>  
                   ...
                   <tr>    
                        <td class="style2"> </td>   
                         <td>  <asp:Button ID="Button1" runat="server" Text="SAVE" OnClick="Button1_Click" href="Parent.aspx" />    </td>  
